...
2023题型：单选（20）填空（20）作图（10）简答（20）综合（30）
...
两个标准：IEEE 802.11系列标准，HiperLAN系列标准
...
> - ZigBee的自愈功能：增加或删除一个节点，节点位置发生变动，节点发生故 障等等，网络都能够自我修复，并对网络拓扑结构进行相应地调整，无需人工干预，保证整个系统仍然能正常工作。
...
ZigBee的网络地址：1个是64位的IEEE地址，通常叫做MAC地址或扩展地址，另一个是16位的网络地址，叫逻辑地址或短地址。
